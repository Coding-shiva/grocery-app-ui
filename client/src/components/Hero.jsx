    ...
    <div className='relative'>
     ...
     <h1 className='text-3xl md:text-4xl font-bold text-center md:text-left max-w-72 md:max-w-80 leading-tight lg:leading-15'>
        ...
        <div className='flex items-center mt-6 font-medium gap-6'>
            <Link to="/products" className='flex group items-center gap-2 px-7 rounded text-white py-3 bg-orange-600 cursor-pointer '>
             Shop Now
             <img src={assets.white_arrow_icon} alt="" className='md:hidden transition group-focus:translate-x-1'/>
            </Link>
             <Link to="/products" className=' hidden md:flex group items-center gap-2 px-7 rounded text-white py-3 bg-orange-600 cursor-pointer '>
             Explore Deals
             <img src={assets.white_arrow_icon} alt="" className='md:hidden transition group-focus:translate-x-1'/>
            </Link>
            </div>      
